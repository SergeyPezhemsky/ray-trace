...
void test_scene1()
{
    ...
    unsigned char* tex2 = stbi_load("../../../textures/wood_planks_new_0025_01_s.jpg",
        ...
        &channels,
        STBI_rgb);
    auto lightSource1 = std::make_shared<LightSource>(float3(0.0f, 10.0f, 0.0f), float3(1.0f, 1.0f, 1.0f));
    ...
    auto plane1 = std::make_shared<Plane>(float3(+0.0f, -1.0f, +0.0f), float3(0.0f, 1.0f, 0.0f), new Defuse(new ImageTexture(tex1, width, height)));//new ConstantTexture(float3(1.0f, 1.0f, 1.0f))
    auto sph = std::make_shared<Sphere>(float3(+0.5f, +8.0f, +11.95f), 0.8, new Defuse(new ConstantTexture(float3(1.0f, 1.0f, 1.0f))));
    auto sph3 = std::make_shared<Sphere>(float3(+3.5f, +2.0f, +2.5f), 2, new Defuse(new ConstantTexture(float3(1.0f, 1.0f, 1.0f))));
    auto sph4 = std::make_shared<Sphere>(float3(+4.5f, +2.0f, 5.0f), 1, new Defuse(new ConstantTexture(float3(1.0f, 1.0f, 1.0f))));
    auto sph5 = std::make_shared<Sphere>(float3(+4.5f, -1.0f, 8.0f), 1, new Defuse(new ConstantTexture(float3(1.0f, 1.0f, 1.0f))));
    auto sph6 = std::make_shared<Sphere>(float3(+1.5f, -1.0f, 9.0f), 1, new Defuse(new ConstantTexture(float3(1.0f, 1.0f, 1.0f))));
    auto sph7 = std::make_shared<Sphere>(float3(0.0f, -1.0f, 5.0f), 1, new Defuse(new ConstantTexture(float3(1.0f, 1.0f, 1.0f))));
    auto sph8 = std::make_shared<Sphere>(float3(-0.5f, -1.0f, 7.0f), 1, new Defuse(new ConstantTexture(float3(1.0f, 1.0f, 1.0f))));
    auto sph9 = std::make_shared<Sphere>(float3(4.0f, 5.0f, 4.0f), 1.5, new Defuse(new ConstantTexture(float3(1.0f, 1.0f, 1.0f))));
    auto sph10 = std::make_shared<Sphere>(float3(-4.0f, 5.0f, 4.0f), 1.5, new Defuse(new ConstantTexture(float3(1.0f, 1.0f, 1.0f))));
    auto sph2 = std::make_shared<Sphere>(float3(-3.0f, +2.5f, +2.5f), 2, new Defuse(new ConstantTexture(float3(1.0f, 1.0f, 1.0f))));//new ImageTexture(tex1, width, height))
    auto par = std::make_shared<Parallel>(float3(+3.0f, -1.0f, 0.0f), float3(+5.0f, +5.0f, +6.0f), new Defuse(new ConstantTexture(float3(1.0f, 1.0f, 1.0f))));
    auto par1 = std::make_shared<Parallel>(float3(+3.0f, -1.0f, -8.0f), float3(+5.0f, +5.0f, -2.0f), new Defuse(new ConstantTexture(float3(1.0f, 1.0f, 1.0f))));
    auto par2 = std::make_shared<Parallel>(float3(-5.0f, -1.0f, 0.0f), float3(-3.0f, +5.0f, +6.0f), new Defuse(new ConstantTexture(float3(1.0f, 1.0f, 1.0f))));
    auto par3 = std::make_shared<Parallel>(float3(-5.0f, -1.0f, -8.0f), float3(-3.0f, 5.0f, -2.0f), new Defuse(new ConstantTexture(float3(1.0f, 1.0f, 1.0f))));
    ...
    scene.geoObjects.push_back(sph7);
    scene.geoObjects.push_back(sph8);
    scene.geoObjects.push_back(sph9);
    scene.geoObjects.push_back(sph10);
    scene.geoObjects.push_back(par);
    scene.geoObjects.push_back(par1);
    scene.geoObjects.push_back(par2);
    scene.geoObjects.push_back(par3);
